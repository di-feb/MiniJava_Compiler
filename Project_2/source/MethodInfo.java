...
public class MethodInfo {
    ...
    private HashMap < String, String > parameters; // Args of the method
    ...
    public HashMap < String, String > getArgs(){ return parameters; }
    ...
    public void setParameters(HashMap < String, String > param){ parameters.putAll(param); }
    public void setVars(HashMap < String, String > var){ vars.putAll(var); }
} 